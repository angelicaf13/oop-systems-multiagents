...
public class Rectangle extends CenteredGraphicalElement
{
    ...
    public Rectangle(final int x, final int y, final Color drawColor, final Color fillColor, final int width, final int height) {
        super(x, y);
    ...
    public Rectangle(final int x, final int y, final Color drawColor, final Color fillColor, final int size) {
    ...
    public String toString() {
        return String.valueOf(this.drawColor.toString()) + " rectangle";
    }
}
